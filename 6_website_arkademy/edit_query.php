            ...
            <div class="block">
              <div class="container">
               <?php
                ...
                ?>
                  <table cellspacing='0'>
                      <form method="post" action="proses_edit_query.php?id=<?php echo $id; ?>" enctype="multipart/form-data"> 
                <label for="name">Name</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="text" id="name" name="name" value="<?php echo $data['name']; ?>">
                <br>    
                <label for="work">Work</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="text" id="work" name="work" value="<?php echo $data['work']; ?>">
                <br>                
                  <label for="salary">Salary</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="text" id="salary" name="salary" value="<?php echo $data['salary']; ?>">
                <br>
                <div class="row">
                <input type="submit" value="Koreksi">
                </div>
                </form>
          </div>
          <!-- Content Row -->
